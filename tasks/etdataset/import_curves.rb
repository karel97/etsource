  ...
  task curves: :environment do
    ...
    curves.each do |country, year|
      ...
      if etdataset_country == 'nl'
        ...
        Pathname.glob("#{ETDATASET_PATH}/curves/demand/households/space_heating/data/nl/1987/output/*.csv").each do |csv|
          cp_csv(csv, dest.join("heat/1987"))
        end
        ...
        Pathname.glob("#{ETDATASET_PATH}/curves/demand/households/space_heating/data/nl/#{ year }/output/*.csv").each do |csv|
          cp_csv(csv, dest.join("heat/default"))
        end
      else
        ...
        FileUtils.ln_sf(Pathname.new("../../nl/curves/heat/"), dest)
      end
